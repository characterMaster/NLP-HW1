...
def parse_args():
    ...
    parser.add_argument('-grammar_file', type=Path, help='Grammar file name', default = './grammar.gr')
...
if __name__ == '__main__':
    ...
    with open(args.grammar_file) as grammar_file:
        ...
        for i in range(args.num_sentences):
            output_tree = grammar.generate_tree(max_non_terms=5)  # Magic constant by Jason.
            if args.tree:
